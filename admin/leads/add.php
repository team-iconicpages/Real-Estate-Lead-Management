...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO leads (full_name, email, phone, property_interest, budget, source, notes, status_id, assigned_to, created_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$full_name, $email, $phone, $property_interest, $budget, $source, $notes, $status_id, $assigned_to, $_SESSION['user_id']]);

    // Redirect to the leads list page after successful insertion
    ...
    <main>
        <section>
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="property_interest" name="property_interest"><br><br>
